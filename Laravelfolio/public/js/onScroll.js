...
var headerOnScrollEffect = {
  ...
  changeElementColor: function changeElementColor() {
    document.addEventListener('scroll', headerOnScrollEffect.handleChangeElementColorScroll);
  },
  handleChangeElementColorScroll: function handleChangeElementColorScroll() {
    // ici je recupère la couleur d'un element de thème variable ( voir le code threejs je fais pareil)
    var colorOfCurrentTheme = getComputedStyle(document.querySelector('.little-square')).backgroundColor;
